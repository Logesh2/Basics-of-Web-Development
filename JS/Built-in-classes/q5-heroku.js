...
const category=courses.filter (function (course)
       {
...
const location=courses.filter (function(course) 
    {
        return course.location.city === 'Bangalore';
    }
  ) ;
  console.log(location);
 
 const online= courses.find (function (course) 
  {
        return course.modes.online === true;
  }
) ;
console.log(online);

const mode= courses.reverse().find (
    function (course) 
    {
        return course.modes.online === true;
    }
...
const first_workshop=courses.find (
    function (course) 
    {
        return course.modes.online ===true & course.modes.inPerson=== true;
    }
);

console.log(first_workshop)
